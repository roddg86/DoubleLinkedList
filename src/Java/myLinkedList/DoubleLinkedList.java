...
public class DoubleLinkedList<T> implements List<T> {
    ...
    private class ListItr implements ListIterator<T> {
        ...
        public void remove() {
             ...
             */
            lastReturned = null;
            /* Увеличиваем счетчик модификаций списка, т.к. мы удалили из него
             * элемент. Поле modCount увеличилось на единицу в методе remove класса DoublyLinkedList
             */
            expectedModCount++;
        }
         ...
         * Этот метод нельзя вызывать после вызовов методов
        ...
        public void add(T e) {
            checkForComodification();
            lastReturned = null;
            DoubleLinkedList.this.add(e, nextIndex);
            nextIndex++;
            expectedModCount++;
        }
        ...
        final void checkForComodification() {
             ...
             * то значения полей modCount и expectedModCount будут совпадать
             */
